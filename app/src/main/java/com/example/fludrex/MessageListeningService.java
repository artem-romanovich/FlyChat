    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        try {
            ...
            Notification notification = builder
                    ...
                    .setSmallIcon(R.drawable.ic_singing_bird)
                    .setPriority(NotificationManager.IMPORTANCE_DEFAULT)
                    .build();

            createNotificationChannel(this, "FlyChat info", "Информирование о службе слушания сообщений. Нажмите для отключения. Возможны баги, решаемые путем включения и перезапуска приложения.", "JH");
