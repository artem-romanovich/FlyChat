...
public class ContactsAdapter extends ArrayAdapter<MyContacts> {
    ...
    public ContactsAdapter(Context context, int resource, ArrayList<MyContacts> contacts, ArrayList<String> CONTACTS) throws IOException {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        int c = (int)(150 + Math.random() * 50);
        int color = Color.argb(255, c, c, c);
        viewHolder.contact_item.setColorFilter(color);
    ...
    private class ViewHolder {
        ...
        ViewHolder(View view) {
            ...
            contact_item = view.findViewById(R.id.contact_item);
        }
    }
