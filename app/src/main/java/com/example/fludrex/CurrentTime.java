...
public class CurrentTime {
    ...
    public String getCurrentTimeFromBaseNextLine(long delay_time) { //Формат - как в правом нижнем углу вашего экрана
    ...
    public String getCurrentTimeFromBase(long delay_time) { //Формат в виде последовательности цифр (удобен для сравнения)
