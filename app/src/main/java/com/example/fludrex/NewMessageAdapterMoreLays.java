...
public class NewMessageAdapterMoreLays extends ArrayAdapter<MyMessage> {
    ...
    public NewMessageAdapterMoreLays(Context context, ArrayList<String> MESSAGES, ArrayList<MyMessage> messages, String my_nic, int IB) {
    ...
    public int getItemViewType(int position) {
        ...
        try{
            if (IB == 1) {
                ...
                if (MESSAGES.get(position).contains("_" + my_nic + "_")) {
                    t = USER_VARIANT;
                } else {
                    t = INTERLOCUTOR_VARIANT;
                }
