...
public class AutoStartHelper {
    ...
    private void showAlert(Context context, DialogInterface.OnClickListener onClickListener) {
        new AlertDialog.Builder(context).setTitle("Разрешить AutoStart")
                .setMessage("Пожалуйста, если вы этого еще не сделали, настройте автозапуск приложения в настройках.")
                .setPositiveButton("Разрешить", onClickListener).show().setCancelable(false);
    }
