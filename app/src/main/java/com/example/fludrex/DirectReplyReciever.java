        ...
        try {
            ...
            if (remoteInput != null) {
                ...
                if (sent_message.equals("") ||
                    ...
                    //MessageListeningService.stop(context);
                                ...
                                public void onDataChange(@NotNull DataSnapshot dataSnapshot11) {
                                    if (dataSnapshot11.exists()
                                        ...
                                        try {
                                            ...
                                            //MessageListeningService.refresh(context, secret_field);
                                            //MessageListeningService.removeNotification(context, MessageListeningService.counter+2);
                ...
                ValueEventListener remove_message_listener = new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        for (DataSnapshot postsnapshot : dataSnapshot.getChildren()) {
                            ...
                            listner_status[0] = 0;
                            Log.wtf("remove_message_listener", get_key);
                        }
                    }
                ...
                try {
                    ...
                    ValueEventListener remove_Notif_listener = new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            //MessageListeningService.removeNotification(context, MessageListeningService.counter);
                        }
                ...
                //MessageListeningService.start(context, secret_field);
                MessageListeningService.removeAllNotifications(context);
                //MessageListeningService.NOTIFICATION.addChildEventListener(MessageListeningService.childEventListener);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
